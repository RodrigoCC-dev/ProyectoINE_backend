...
public class PiramidePoblacional {
	...
	public PiramidePoblacional sumarPiramides(PiramidePoblacional parcial, PiramidePoblacional total) {
	...
	public PiramidePoblacional calcularPiramidePorComunas(List<Comuna> listaComunas) {
		...
		for(int i = 1; i < listaComunas.size(); i++) {
			...
			total = this.sumarPiramides(parcial, total);
		}
		return total;
	}
	...
	public PiramidePoblacional calcularPiramidePorRegiones(List<Region> listaRegiones) {
		PiramidePoblacional parcial;
		PiramidePoblacional total = this.calcularPiramidePorProvincias(listaRegiones.get(0).getListaProvincias());
		for(int i = 1; i < listaRegiones.size(); i++) {
			parcial = this.calcularPiramidePorProvincias(listaRegiones.get(i).getListaProvincias());
			total = this.sumarPiramides(parcial, total);
		}
		return total;
	}
